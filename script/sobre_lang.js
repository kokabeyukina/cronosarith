...
function translates(lang){
    ...
    switch(lang){
        ...
        case 'en':
            ...
            break;
        case 'ja':
            document.querySelector('title').innerHTML = '電卓について';
...
<h2>使い方:</h2>
<p>
    &ensp;この電卓は、「関数」フィールドに指定された関数を使用して機能し、x 軸 (赤) 上の各点に x を代入し、
...
<h2>範囲 t:</h2>
<p>
    &ensp;残念ながら、虚数を x として受け入れ、別の虚数を y として返すグラフ電卓を作成するには、x と y の虚数部分に 2 つ、
...
<h3>センシビリティーと距離:</h3>
<p>
    &ensp;センシビリティーは、グラフの角度を変更するために必要なマウス/指のドラッグを定義します。
